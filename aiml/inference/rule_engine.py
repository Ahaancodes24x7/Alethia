...
=========================
The Alethia Rule Engine.

Takes a 60-second feature window dict and emits the strictly typed
state object defined in the Alethia spec:

  - drift_score          : 0-100
  - cognitive_risk_level : LOW | MODERATE | HIGH | CRITICAL
  - confusion_flags      : List[str]
  - attention_risk       : 0-100
  - fatigue_risk         : 0-100
  - intervention         : { action, target, urgency, message }
